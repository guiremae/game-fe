...
export class GameCardComponent implements OnInit {
  ...
  constructor(private igdbService: IgdbService, private authService: AuthService, private modalService: ModalService) { }
  ...
  ngOnInit(): void {
    ...
    this.date = new Date (this.game.first_release_date*1000).toLocaleDateString("es-ES")
